...
# eigenvectors of covariance matrix as principal components for projection of samples for dimension reduction--consider dimension reduction in dot products by projection, and eigenvectors as new basis vectors.
